...
class ArticleController extends Controller
{
    ...
    public function create()
    {
        ...
        $article = new Article([
            ...
            'author' => $defaultAuthor?->name ?? 'Hendra Setiyawan, S.E., M.Ak., Ak., CA',
            'author_role' => $defaultAuthor?->role ?? 'Managing Partner & Kuasa Hukum Pengadilan Pajak',
    ...
    public function store(Request $request)
    {
        ...
        $article = Article::create([
            ...
            'author_id' => $authorId,
            'author' => $authorName ?: 'Hendra Setiyawan, S.E., M.Ak., Ak., CA',
            'author_role' => $authorRole ?? 'Managing Partner & Kuasa Hukum Pengadilan Pajak',
